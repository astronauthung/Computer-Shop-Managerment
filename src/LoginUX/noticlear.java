...
public class noticlear extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Đã xóa thành công");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(noticlear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
