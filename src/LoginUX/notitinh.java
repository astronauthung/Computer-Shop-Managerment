...
public class notitinh extends javax.swing.JFrame {

    int positionX = 0, posintionY = 0;
    public notitinh() {
        initComponents();
        icon();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("  Nhập đầy đủ thông tin trước tính toán");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(notitinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
